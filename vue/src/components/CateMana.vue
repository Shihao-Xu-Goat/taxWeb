<template>
  <el-container>
    <el-header class="cate_mana_header">
      ...
      <el-button type="primary" size="medium" style="margin-left: 10px" @click="addNewCate">Create</el-button>
    </el-header>
    <el-main class="cate_mana_main">
      <el-table
        ...
        <el-table-column label="Options" align="left">
      ...
      <el-button type="danger" :disabled="this.selItems.length==0" style="margin-top: 10px;width: 100px;"
                 @click="deleteAll" v-if="this.categories.length>0">Delete All
      </el-button>
    </el-main>
  </el-container>
</template>
<script>
  ...
  export default{
    methods: {
      ...
      deleteAll(){
        var _this = this;
        this.$confirm('Are you sure, the ' + this.selItems.length + 'categorys will be deleted', 'Warning', {
          type: 'warning',
      ...
      handleEdit(index, row){
        var _this = this;
        this.$prompt('Please input the new category', 'edit', {
          confirmButtonText: 'OK',
      ...
      handleDelete(index, row){
        let _this = this;
        this.$confirm('This category ' + row.cateName + ' will be delete ?', 'Warning', {
          confirmButtonText: 'OK',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
      ...
      deleteCate(ids){
        ...
        deleteRequest("/admin/category/" + ids).then(resp=> {
          ...
          if (resp.response.status == 403) {
            ...
            _this.$message({
              type: 'error',
              message: 'There are doc belonging to this category, can not be deleted!'
            });
          }
        })
      },
